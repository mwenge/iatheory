...
location (\icode{MainControlLoop\index{MainControlLoop}}) the next time it wakes up and wonders what to do. This will be in a few
microseconds time. When it starts executing \icode{MainControlLoop\index{MainControlLoop}}, Iridis Alpha will get underway.
