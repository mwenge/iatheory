...
\begin{figure}[H]
  {
	...
	\end{subfigure}
  }\caption*{The enemy in level 1, controlled by the Level Data below.}
  {
  \setlength{\tabcolsep}{3.0pt}
  \setlength\cmidrulewidth{\heavyrulewidth} % Make cmidrule = 
...
\subsection{Something Simple - Byte 0: The Enemy's Color}
...
\subsection{Bytes 1-4: Sprite Animation}
\begin{q}{Jeff Minter's Development Diary in Zzap Magazine\cite{planner}}
...
\subsection{Bytes 18-21: Enemy Movement}
...
\subsubsection{What is going on with Byte 6?}
...
\subsection{Bytes 6-8: Alternate Enemy Waves}
...
\subsection{Bytes 22-23: The Bytes of Death}
\begin{figure}[H]
  {
    \setlength{\tabcolsep}{3.0pt}
    \setlength\cmidrulewidth{\heavyrulewidth} % Make cmidrule = 
...
\subsection{Byte 35: Energy Multiplier}
...
\subsection{Byte 34: Score for Hitting the Enemey}
