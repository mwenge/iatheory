...
This section provides the level data for each wave of enemies\index{enemies} in each
planet\index{planet}. Figures are provided to indicate the appearance and movement\index{movement}
pattern\index{pattern} of the enemy.
