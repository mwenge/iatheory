...
boiler-room is \icode{PerformMainGameUpdate\index{PerformMainGameUpdate}}:
...
\icode{PerformMainGameUpdate\index{PerformMainGameUpdate}}, along with a routine\index{routine} called \icode{AnimateStarFieldAndScrollPlanets\index{AnimateStarFieldAndScrollPlanets}}
