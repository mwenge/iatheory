...
6502 Assembly, is no longer in contemporary use but it is one 

\clearpage
\begin{figure}[H]
  {
    \begin{adjustbox}{width=12cm,center}
      \frame{\surface{preface/1.png}}
    \end{adjustbox}
  }\caption*{The Iridis Alpha title screen.}
\end{figure}
\vspace{-0.5cm}
\begin{figure}[H]
  {
    \begin{adjustbox}{width=12cm,center}
      \frame{\surface{preface/2a.png}}
    \end{adjustbox}
  }\caption*{Iridis Alpha: On the Brick Planet.}
\end{figure}
\clearpage
...
\begin{figure}[H]
  {
    \begin{adjustbox}{width=12cm,center}
      \frame{\surface{preface/3.png}}
    \end{adjustbox}
  }\caption*{Walking on the Forest Planet.}
\end{figure}
\vspace{-0.5cm}
\begin{figure}[H]
  {
    \begin{adjustbox}{width=12cm,center}
      \frame{\surface{preface/4.png}}
    \end{adjustbox}
  }\caption*{Near the stargates on the Brick Planet.}
\end{figure}
\clearpage
