...
\CopyPartialFile{../iridisalpha/src/graphics/charset.asm}{tmp.asm}{3}{12}%
\lstinputlisting[basicstyle=\tiny,caption=The 'stripe' character.]{tmp.asm}
...
\CopyPartialFile{../iridisalpha/src/iridisalpha.asm}{tmp.asm}{413}{441}%
\lstinputlisting[caption=The 'stripe' character.]{tmp.asm}
...
\CopyPartialFile{../iridisalpha/src/iridisalpha.asm}{tmp.asm}{272}{310}%
\lstinputlisting[caption=\icode{TitleScreenAnimation} responsible for choosing what to do at each interrupt.]{tmp.asm}
...
\CopyPartialFile{../iridisalpha/src/iridisalpha.asm}{tmp.asm}{316}{323}%
\lstinputlisting[caption= The start of \icode{DoStarfieldAnimation} responsible for painting stars.]{tmp.asm}
...
\CopyPartialFile{../iridisalpha/src/iridisalpha.asm}{tmp.asm}{325}{339}%
\lstinputlisting[caption=MSBXPos.. some'it.]{tmp.asm}
...
\CopyPartialFile{../iridisalpha/src/iridisalpha.asm}{tmp.asm}{580}{614}%
\lstinputlisting[caption=The loop in \icode{UpdateJumpingGilbyPositionsAndColors} updating the x and y position on screen and color of each of the gilby sprites.]{tmp.asm}
