...
With our character\index{character} set defined we can now write some text to the screen\index{screen} ram. Note that when we write it to \icode{SCREEN\_RAM}
...
This routine\index{routine} works by calling one of three different sub-routines each time it's called. It picks the one to run
