...
MaybeStartNewTune                                                 MaybeStartNewTune   
        ...
        ; We'll only select a new tune when we've reached the             ; We'll only select a new tune when we've reached the
        ; beginning of a new 16 bar structure.                            ; beginning of a new 16 bar structure.
        INX                                                               INX
        TXA                                                               TXA
        AND #$03                                                          AND #$03
...
MaybePlayVoice2                                                   MaybePlayVoice2   
        ...
        ; notes played by voice 1.                                        ; notes played by voice 3. 
